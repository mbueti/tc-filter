SUBROUTINE WNLSM(W,MDW,MME,MA,N,L,PRGOPT,X,RNORM,MODE,IPIVOT, ITYPE,WD,H,SCALE,Z,TEMP,D)
!***BEGIN PROLOGUE  WNLSM
!***REFER TO  WNNLS
!
!     This is a companion subfoo to WNNLS( ).
...
!++
  ...
  integer :: i, igo897, igo938, igo958, igo977, igo980, igo983,igo986, igo991, igo995, igo998, imax, iopt, isol,itemp, iter, &
             itmax, iwmax, j, jcon, jj, jm1, jp, l1,key, krank, krp1, last, link, lp1, m, me, mep1, nerr,next, niv, niv1, &
             nlink, ntimes, nsp1, nsoln, np1,nopt, nm1, ISAMAX
  REAL, DIMENSION(1) :: X, WD, H, SCALE, Z, TEMP, PRGOPT
  REAL, DIMENSION(4) :: DOPE
  REAL, DIMENSION(5) :: SPARAM
  REAL, DIMENSION(MDW, N) :: W
  REAL, DIMENSION(N) :: D
  REAL :: ALAMDA, ALPHA, ALSQ, AMAX, BNORM, EANORM, SRELPR, FAC, ONE, BLOWUP, RNORM, SM, T, TAU, TWO, WMAX, ZERO, ZZ, Z2, &
          AMAX1, SQRT, SNRM2, SASUM
  INTEGER, DIMENSION(25) :: IPIVOT
  INTEGER, DIMENSION(8) :: IDOPE
