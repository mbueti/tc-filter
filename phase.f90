...
!************************************************************************
  ...
  REAL :: amm, amp, amp1, chg, ckg, cosf, fact,  tn, tnn, tff, tfr, zz
  INTEGER :: i,  imxm, irt, ismth, k, kt, kty, j, jmxm, na, nn, nty, ntym, nz
...
801 CONTINUE
  ...
  END DO
!
!C       WRITE(6,815) (TK(KK),KK = 1 , NTY)
!C815    FORMAT(2X,'THIS IS TK:',E12.6)
!
!
